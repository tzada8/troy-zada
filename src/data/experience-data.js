		...
		data: [
			{
				...
				description:
					"Bachelor of Applied Science candidate developing expertise in data analytics, information systems, operations management, and organizational behaviour. Some important courses to highlight include: Algorithms and Data Structures (Java), Databases and Software Design (SQL), Statistics (R), Optimization, and Organizational Behaviour",
			},
		],
	},
	work: {
		...
		data: [
			...
			},
			{
				...
				description:
					"Operated and programmed numerous machines including a CNC Milling Machine, Lathe, Drill Press, and Pantograph to engrave, polish, and mill various parts. Then, validated that each part precisely met drawing specifications",
			},
		],
	},
	awards: {
