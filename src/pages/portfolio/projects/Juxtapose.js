		...
		<div>
			...
			<GroupedList
				...
				bullets={[
					{
						label: "Search",
						content: "Search for product category (e.g., DSLR cameras)",
					},
					{
