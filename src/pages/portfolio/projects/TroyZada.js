...
export default function TroyZada() {
	return (
		<div>
			...
			<GroupedList
				header="Users can view information about me in one of following categories:"
				bullets={[
					{ label: "Home", content: "Basic information as well as social media links" },
					{
						label: "Education",
						content: "Universities I attended and awards I achieved",
					},
					{ label: "Experience", content: "Previous history of companies I worked at" },
					{
						label: "Skills",
						content: "Proficiency in interpersonal and professional skills",
					},
